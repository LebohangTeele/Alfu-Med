 ...
 */
public class ShowMeasuredRecordLayout extends RelativeLayout {


    private OnSizeChangedListener mSizeChangedListener;
    private int mExpandedHeight = -1;

    public ShowMeasuredRecordLayout(Context context) {
        super(context);
    }

    public ShowMeasuredRecordLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ShowMeasuredRecordLayout(Context context, AttributeSet attrs, int defStyle) {
